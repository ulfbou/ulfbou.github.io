...
public partial class MainLayout : LayoutComponentBase
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {
            logger = logger
                .ForContext("Audience", AudienceService.CurrentAudience);
            logger.Information("MainLayout initialized with audience: {Audience}", AudienceService.CurrentAudience);
        }
        else
        {
            logger = logger.ForContext("Audience", "null");
        }

        logger.Information("Initializing MainLayout");
